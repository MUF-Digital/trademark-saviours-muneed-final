...
!function(a) {
    ...
    a.prototype.addSlide = a.prototype.slickAdd = function(b, a, c) {
        ...
        if ("boolean" == typeof a)
            c = a,
            a = null;
        else if (a < 0 || a >= _.slideCount)
            return !1;
        _.unload(),
        "number" == typeof a ? 0 === a && 0 === _.$slides.length ? $(b).appendTo(_.$slideTrack) : c ? $(b).insertBefore(_.$slides.eq(a)) : $(b).insertAfter(_.$slides.eq(a)) : !0 === c ? $(b).prependTo(_.$slideTrack) : $(b).appendTo(_.$slideTrack),
    ...
    a.prototype.animateSlide = function(a, b) {
        ...
        $({
            ...
            step: function(a) {
                a = Math.ceil(a),
                !1 === _.options.vertical ? (c[_.animType] = "translate(" + a + "px, 0px)",
                _.$slideTrack.css(c)) : (c[_.animType] = "translate(0px," + a + "px)",
                _.$slideTrack.css(c))
            },
            complete: function() {
                b && b.call()
    ...
    a.prototype.getNavTarget = function() {
        ...
        return a && null !== a && (a = $(a).not(this.$slider)),
        a
    }
    ,
    ...
    a.prototype.autoPlayIterator = function() {
        ...
        _.paused || _.interrupted || _.focussed || (!1 === _.options.infinite && (1 === _.direction && _.currentSlide + 1 === _.slideCount - 1 ? _.direction = 0 : 0 === _.direction && (a = _.currentSlide - _.options.slidesToScroll,
    ...
    a.prototype.buildDots = function() {
        ...
        if (!0 === _.options.dots && _.slideCount > _.options.slidesToShow) {
            ...
            a = 0; a <= _.getDotCount(); a += 1)
                b.append($("<li />").append(_.options.customPaging.call(this, _, a)));
    ...
    a.prototype.checkResponsive = function(b, h) {
        var c, a, d, _ = this, e = !1, f = _.$slider.width(), g = window.innerWidth || $(window).width();
        if ("window" === _.respondTo ? d = g : "slider" === _.respondTo ? d = f : "min" === _.respondTo && (d = Math.min(g, f)),
        _.options.responsive && _.options.responsive.length && null !== _.options.responsive) {
            for (c in a = null,
            _.breakpoints)
                _.breakpoints.hasOwnProperty(c) && (!1 === _.originalSettings.mobileFirst ? d < _.breakpoints[c] && (a = _.breakpoints[c]) : d > _.breakpoints[c] && (a = _.breakpoints[c]));
            null !== a ? null !== _.activeBreakpoint ? (a !== _.activeBreakpoint || h) && (_.activeBreakpoint = a,
            "unslick" === _.breakpointSettings[a] ? _.unslick(a) : (_.options = $.extend({}, _.originalSettings, _.breakpointSettings[a]),
            !0 === b && (_.currentSlide = _.options.initialSlide),
            _.refresh(b)),
            e = a) : (_.activeBreakpoint = a,
            "unslick" === _.breakpointSettings[a] ? _.unslick(a) : (_.options = $.extend({}, _.originalSettings, _.breakpointSettings[a]),
            !0 === b && (_.currentSlide = _.options.initialSlide),
            _.refresh(b)),
            e = a) : null !== _.activeBreakpoint && (_.activeBreakpoint = null,
    ...
    a.prototype.changeSlide = function(b, e) {
        ...
        switch (a.is("a") && b.preventDefault(),
        a.is("li") || (a = a.closest("li")),
        c = this.slideCount % this.options.slidesToScroll != 0 ? 0 : (this.slideCount - this.currentSlide) % this.options.slidesToScroll,
        b.data.message) {
        case "previous":
            d = 0 === c ? this.options.slidesToScroll : this.options.slidesToShow - c,
    ...
    a.prototype.cleanUpRows = function() {
        var a;
        this.options.rows > 1 && ((a = this.$slides.children().children()).removeAttr("style"),
    ...
    a.prototype.fadeSlide = function(a, b) {
        ...
        _.$slides.eq(a).animate({
            opacity: 1
        }, _.options.speed, _.options.easing, b)) : (_.applyTransition(a),
        _.$slides.eq(a).css({
            opacity: 1,
            zIndex: _.options.zIndex
        }),
        b && setTimeout(function() {
            _.disableTransition(a),
            b.call()
        }, _.options.speed))
    }
    ,
    ...
    a.prototype.focusHandler = function() {
        ...
        _.$slider.off("focus.slick blur.slick").on("focus.slick blur.slick", "*:not(.slick-arrow)", function(a) {
            ...
            var b = $(this);
            setTimeout(function() {
                _.options.pauseOnFocus && (_.focussed = b.is(":focus"),
                _.autoPlay())
            }, 0)
        })
    }
    ...
    a.prototype.getDotCount = function() {
        ...
        if (!0 === this.options.infinite)
            ...
            a = 1 + Math.ceil((this.slideCount - this.options.slidesToShow) / this.options.slidesToScroll);
        return a - 1
    }
    ,
    a.prototype.getLeft = function(a) {
        var e, c, b, _ = this, d = 0;
        ...
        d = -(c * _.options.slidesToShow * 1)),
        _.slideCount % _.options.slidesToScroll != 0 && a + _.options.slidesToScroll > _.slideCount && _.slideCount > _.options.slidesToShow && (a > _.slideCount ? (_.slideOffset = -((_.options.slidesToShow - (a - _.slideCount)) * _.slideWidth * 1),
        d = -((_.options.slidesToShow - (a - _.slideCount)) * c * 1)) : (_.slideOffset = -(_.slideCount % _.options.slidesToScroll * _.slideWidth * 1),
        d = -(_.slideCount % _.options.slidesToScroll * c * 1)))) : a + _.options.slidesToShow > _.slideCount && (_.slideOffset = (a + _.options.slidesToShow - _.slideCount) * _.slideWidth,
        ...
        !0 === _.options.variableWidth && (b = _.slideCount <= _.options.slidesToShow || !1 === _.options.infinite ? _.$slideTrack.children(".slick-slide").eq(a) : _.$slideTrack.children(".slick-slide").eq(a + _.options.slidesToShow),
        e = !0 === _.options.rtl ? b[0] ? -((_.$slideTrack.width() - b[0].offsetLeft - b.width()) * 1) : 0 : b[0] ? -1 * b[0].offsetLeft : 0,
        !0 === _.options.centerMode && (b = _.slideCount <= _.options.slidesToShow || !1 === _.options.infinite ? _.$slideTrack.children(".slick-slide").eq(a) : _.$slideTrack.children(".slick-slide").eq(a + _.options.slidesToShow + 1),
        e = !0 === _.options.rtl ? b[0] ? -((_.$slideTrack.width() - b[0].offsetLeft - b.width()) * 1) : 0 : b[0] ? -1 * b[0].offsetLeft : 0,
    ...
    a.prototype.getNavigableIndexes = function() {
        var b, a = 0, c = 0, d = [];
        for (!1 === this.options.infinite ? b = this.slideCount : (a = -1 * this.options.slidesToScroll,
        c = -1 * this.options.slidesToScroll,
        b = 2 * this.slideCount); a < b; )
            d.push(a),
    ...
    a.prototype.getSlideCount = function() {
        var a, b, _ = this;
        return (b = !0 === _.options.centerMode ? _.slideWidth * Math.floor(_.options.slidesToShow / 2) : 0,
        !0 === _.options.swipeToSlide) ? (_.$slideTrack.find(".slick-slide").each(function(d, c) {
            if (c.offsetLeft - b + $(c).outerWidth() / 2 > -1 * _.swipeLeft)
                return a = c,
                !1
        }),
        Math.abs($(a).attr("data-slick-index") - _.currentSlide) || 1) : _.options.slidesToScroll
    }
    ,
    ...
    a.prototype.initADA = function() {
        ...
        _.$slides.not(_.$slideTrack.find(".slick-cloned")).each(function(a) {
            $(this).attr({
                role: "option",
                "aria-describedby": "slick-slide" + _.instanceUid + a
            })
        }),
        null !== _.$dots && _.$dots.attr("role", "tablist").find("li").each(function(a) {
            $(this).attr({
                role: "presentation",
                "aria-selected": "false",
                "aria-controls": "navigation" + _.instanceUid + a,
    ...
    a.prototype.initSlideEvents = function() {
        this.options.pauseOnHover && (this.$list.on("mouseenter.slick", $.proxy(this.interrupt, this, !0)),
    ...
    a.prototype.lazyLoad = function() {
        ...
        !0 === _.options.centerMode ? !0 === _.options.infinite ? b = (a = _.currentSlide + (_.options.slidesToShow / 2 + 1)) + _.options.slidesToShow + 2 : (a = Math.max(0, _.currentSlide - (_.options.slidesToShow / 2 + 1)),
        b = 2 + (_.options.slidesToShow / 2 + 1) + _.currentSlide) : (b = Math.ceil((a = _.options.infinite ? _.options.slidesToShow + _.currentSlide : _.currentSlide) + _.options.slidesToShow),
        !0 === _.options.fade && (a > 0 && a--,
        b <= _.slideCount && b++)),
        c(_.$slider.find(".slick-slide").slice(a, b)),
        _.slideCount <= _.options.slidesToShow ? c(_.$slider.find(".slick-slide")) : _.currentSlide >= _.slideCount - _.options.slidesToShow ? c(_.$slider.find(".slick-cloned").slice(0, _.options.slidesToShow)) : 0 === _.currentSlide && c(_.$slider.find(".slick-cloned").slice(-1 * _.options.slidesToShow))
    }
    ,
    ...
    a.prototype.postSlide = function(a) {
        var _ = this;
        _.unslicked || (_.$slider.trigger("afterChange", [_, a]),
        _.animating = !1,
        _.setPosition(),
        _.swipeLeft = null,
    ...
    a.prototype.progressiveLazyLoad = function(b) {
        b = b || 1;
        var e, c, a, _ = this, d = $("img[data-lazy]", _.$slider);
        d.length ? (c = (e = d.first()).attr("data-lazy"),
        (a = document.createElement("img")).onload = function() {
            e.attr("src", c).removeAttr("data-lazy").removeClass("slick-loading"),
            !0 === _.options.adaptiveHeight && _.setPosition(),
            _.$slider.trigger("lazyLoaded", [_, e, c]),
        ...
        a.onerror = function() {
            ...
            _.$slider.trigger("lazyLoadError", [_, e, c]),
            _.progressiveLazyLoad())
        }
        ,
        a.src = c) : _.$slider.trigger("allImagesLoaded", [_])
    }
    ,
    ...
    a.prototype.registerBreakpoints = function() {
        var c, d, a, _ = this, b = _.options.responsive || null;
        if ("array" === $.type(b) && b.length) {
            for (c in _.respondTo = _.options.respondTo || "window",
            b)
                if (a = _.breakpoints.length - 1,
                d = b[c].breakpoint,
                b.hasOwnProperty(c)) {
                    for (; a >= 0; )
                        _.breakpoints[a] && _.breakpoints[a] === d && _.breakpoints.splice(a, 1),
                        a--;
    ...
    a.prototype.removeSlide = a.prototype.slickRemove = function(a, b, c) {
        var _ = this;
        if (a = "boolean" == typeof a ? !0 === (b = a) ? 0 : _.slideCount - 1 : !0 === b ? --a : a,
    ...
    a.prototype.setCSS = function(b) {
        ...
        a[_.positionProp] = b,
        !1 === _.transformsEnabled ? _.$slideTrack.css(a) : (a = {},
        !1 === _.cssTransitions ? (a[_.animType] = "translate(" + c + ", " + d + ")",
        _.$slideTrack.css(a)) : (a[_.animType] = "translate3d(" + c + ", " + d + ", 0px)",
        _.$slideTrack.css(a)))
    }
    ,
    ...
    a.prototype.setOption = a.prototype.slickSetOption = function() {
        var c, d, e, a, b, _ = this, f = !1;
        if ("object" === $.type(arguments[0]) ? (e = arguments[0],
        f = arguments[1],
        b = "multiple") : "string" === $.type(arguments[0]) && (e = arguments[0],
        a = arguments[1],
        f = arguments[2],
        "responsive" === arguments[0] && "array" === $.type(arguments[1]) ? b = "responsive" : void 0 !== arguments[1] && (b = "single")),
        "single" === b)
            _.options[e] = a;
        else if ("multiple" === b)
            $.each(e, function(a, b) {
            ...
            for (d in a)
                if ("array" !== $.type(_.options.responsive))
                    ...
                    for (c = _.options.responsive.length - 1; c >= 0; )
                        _.options.responsive[c].breakpoint === a[d].breakpoint && _.options.responsive.splice(c, 1),
                        c--;
    ...
    a.prototype.setProps = function() {
        ...
        void 0 !== a.OTransform && (_.animType = "OTransform",
        _.transformType = "-o-transform",
        _.transitionType = "OTransition",
        void 0 === a.perspectiveProperty && void 0 === a.webkitPerspective && (_.animType = !1)),
        void 0 !== a.MozTransform && (_.animType = "MozTransform",
        _.transformType = "-moz-transform",
        _.transitionType = "MozTransition",
        void 0 === a.perspectiveProperty && void 0 === a.MozPerspective && (_.animType = !1)),
        void 0 !== a.webkitTransform && (_.animType = "webkitTransform",
        _.transformType = "-webkit-transform",
        _.transitionType = "webkitTransition",
        void 0 === a.perspectiveProperty && void 0 === a.webkitPerspective && (_.animType = !1)),
        void 0 !== a.msTransform && (_.animType = "msTransform",
        _.transformType = "-ms-transform",
        _.transitionType = "msTransition",
        void 0 === a.msTransform && (_.animType = !1)),
        void 0 !== a.transform && !1 !== _.animType && (_.animType = "transform",
    ...
    a.prototype.setSlideClasses = function(a) {
        ...
        !0 === this.options.centerMode ? (d = Math.floor(this.options.slidesToShow / 2),
        !0 === this.options.infinite && (a >= d && a <= this.slideCount - 1 - d ? this.$slides.slice(a - d, a + d + 1).addClass("slick-active").attr("aria-hidden", "false") : (c = this.options.slidesToShow + a,
        b.slice(c - d + 1, c + d + 2).addClass("slick-active").attr("aria-hidden", "false")),
        ...
        this.$slides.eq(a).addClass("slick-center")) : a >= 0 && a <= this.slideCount - this.options.slidesToShow ? this.$slides.slice(a, a + this.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : b.length <= this.options.slidesToShow ? b.addClass("slick-active").attr("aria-hidden", "false") : (e = this.slideCount % this.options.slidesToShow,
        c = !0 === this.options.infinite ? this.options.slidesToShow + a : a,
        this.options.slidesToShow == this.options.slidesToScroll && this.slideCount - a < this.options.slidesToShow ? b.slice(c - (this.options.slidesToShow - e), c + e).addClass("slick-active").attr("aria-hidden", "false") : b.slice(c, c + this.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")),
    ...
    a.prototype.setupInfinite = function() {
        ...
        !0 === _.options.infinite && !1 === _.options.fade && (b = null,
        _.slideCount > _.options.slidesToShow)) {
            for (c = !0 === _.options.centerMode ? _.options.slidesToShow + 1 : _.options.slidesToShow,
            a = _.slideCount; a > _.slideCount - c; a -= 1)
                b = a - 1,
                $(_.$slides[b]).clone(!0).attr("id", "").attr("data-slick-index", b - _.slideCount).prependTo(_.$slideTrack).addClass("slick-cloned");
            for (a = 0; a < c; a += 1)
                b = a,
                $(_.$slides[b]).clone(!0).attr("id", "").attr("data-slick-index", b + _.slideCount).appendTo(_.$slideTrack).addClass("slick-cloned");
    ...
    a.prototype.slideHandler = function(b, e, f) {
        var a, c, h, g, d, i = null, _ = this;
        if (e = e || !1,
        (!0 !== _.animating || !0 !== _.options.waitForAnimate) && (!0 !== _.options.fade || _.currentSlide !== b) && !(_.slideCount <= _.options.slidesToShow)) {
            if (!1 === e && _.asNavFor(b),
            a = b,
            i = _.getLeft(a),
            g = _.getLeft(_.currentSlide),
            _.currentLeft = null === _.swipeLeft ? g : _.swipeLeft,
            !1 === _.options.infinite && !1 === _.options.centerMode && (b < 0 || b > _.getDotCount() * _.options.slidesToScroll) || !1 === _.options.infinite && !0 === _.options.centerMode && (b < 0 || b > _.slideCount - _.options.slidesToScroll)) {
                !1 === _.options.fade && (a = _.currentSlide,
                !0 !== f ? _.animateSlide(g, function() {
                    _.postSlide(a)
                }) : _.postSlide(a));
                return
            }
            if (_.options.autoplay && clearInterval(_.autoPlayTimer),
            c = a < 0 ? _.slideCount % _.options.slidesToScroll != 0 ? _.slideCount - _.slideCount % _.options.slidesToScroll : _.slideCount + a : a >= _.slideCount ? _.slideCount % _.options.slidesToScroll != 0 ? 0 : a - _.slideCount : a,
            _.animating = !0,
    ...
    a.prototype.swipeDirection = function() {
        ...
        a <= 45 && a >= 0 || a <= 360 && a >= 315) ? !1 === this.options.rtl ? "left" : "right" : a >= 135 && a <= 225 ? !1 === this.options.rtl ? "right" : "left" : !0 === this.options.verticalSwiping ? a >= 35 && a <= 135 ? "down" : "up" : "vertical"
    }
    ,
    a.prototype.swipeEnd = function(c) {
        ...
        _.touchObject.swipeLength >= _.touchObject.minSwipe) {
            ...
            case "left":
            case "down":
                a = _.options.swipeToSlide ? _.checkNavigable(_.currentSlide + _.getSlideCount()) : _.currentSlide + _.getSlideCount(),
    ...
    a.prototype.swipeHandler = function(a) {
        ...
        if (!1 !== _.options.swipe && (!("ontouchend"in document) || !1 !== _.options.swipe) && (!1 !== _.options.draggable || -1 === a.type.indexOf("mouse")))
            switch (_.touchObject.fingerCount = a.originalEvent && void 0 !== a.originalEvent.touches ? a.originalEvent.touches.length : 1,
    ...
    a.prototype.swipeMove = function(b) {
        var e, f, c, d, a, _ = this;
        return a = void 0 !== b.originalEvent ? b.originalEvent.touches : null,
        !!_.dragging && (!a || 1 === a.length) && ((e = _.getLeft(_.currentSlide),
        ...
        f = _.swipeDirection(),
        "vertical" === f) ? void 0 : (void 0 !== b.originalEvent && _.touchObject.swipeLength > 4 && b.preventDefault(),
        ...
        !1 === _.options.infinite && (0 === _.currentSlide && "right" === f || _.currentSlide >= _.getDotCount() && "left" === f) && (c = _.touchObject.swipeLength * _.options.edgeFriction,
    ...
    $.fn.slick = function() {
        ...
        for (b = 0; b < f; b++)
            if ("object" == typeof c || void 0 === c ? _[b].slick = new a(_[b],c) : d = _[b].slick[c].apply(_[b].slick, e),
            void 0 !== d)
                return d;
        return _
    }
